...
public class DeviceSettings extends PreferenceActivity implements
    ...
    public static final String KEY_INTELLI_CORE = "intelli_core_temp";
    public static final String KEY_INTELLI_TEMP = "intelli_temp";
    public static final String KEY_TEMP_EXTRAS = "key_intelli_settings";
    ...
    private PreferenceCategory intelliThermalCategory;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        intelliThermalCategory = (PreferenceCategory)findPreference(KEY_TEMP_EXTRAS);
        ...
        setSettingsPresetsDependents(shouldRestorePreset);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == restoreOnBootPreference ||
            ...
            if (preference == restoreOnBootPreference)
                ...
                setSettingsPresetsDependents(value);
            }
            editor.commit();
        }
